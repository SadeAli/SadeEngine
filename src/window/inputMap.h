...
/*
 * Even though all the keys are defined inside GLFW, I'm redefining them here.
 * Because I don't want to include GLFW in every file that needs to use the keys.
 * Also if I ever change the backend it will be easier to maintain the code
*/
